...
После начала операции строишь только хранилища, шахты, и академию.
Штаб НЕ повышаешь!
В итоге тебе либо сразу дают базы без обороны, либо надо несколько раз пролистнуть базы, чтобы дали базу без обороны.
В итоге за час набиваешь 8 лег. модулей для грана. А заодно и для других войск.
И к середине игры бегаешь гранами с 4м лег. модулем.
Это в разы ускоряет получение ресурсов в единицу времени. Т.к. ты со стороны, где нет амплифаеров на 7 секунд щита (от лег. модуля), подчищаешь шахты и хранилища.
